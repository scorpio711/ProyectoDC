    ...
    <section class="bg-white mt-12 dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
            <div
                ...
                <h1 class="text-gray-900 dark:text-white text-3xl md:text-5xl font-extrabold mb-2">Bienvenido a la
                    pagina de Administrador</h1>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div
                    ...
                    <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Administrar Investigaciones
                    </h2>
                    <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">Static websites are now used to
                        bootstrap lots of websites and are becoming the basis for a variety of tools that even influence
                        both web designers and developers.</p>
                    <div class="flex flex-col">
                        <a href="/admin/Investigaciones/administrar.php"
