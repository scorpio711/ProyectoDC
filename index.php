...
<div class="container mx-auto p-4 md:py-12 mt-10">
            ...
            <div class="grid gap-8 md:grid-cols-2 lg:gap-12">
                <div>
                    <div class="h-64 overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-auto">
                        <img src="/build/img/jared-rice-NTyBbu66_SI-unsplash (1).webp" loading="lazy"
                ...
                <div class="md:pt-8">
                    ...
                    <p class="mb-6 text-gray-500 sm:text-lg md:mb-8">
                        ...
                        individuo viva una vida plena y saludable, sin importar los desafíos que enfrenten. <a href="#"
                            class="text-indigo-500 underline transition duration-100 hover:text-indigo-600 active:text-indigo-700">Mas
                            sobre nosotros</a>
                    </p>

                    <h2
                        class="mb-2 text-center text-xl font-semibold text-gray-800 sm:text-2xl md:mb-4 md:text-left dark:text-white">
                        Sobre Nosotros</h2>

                    <p class="mb-6 text-gray-500 sm:text-lg md:mb-8">En el Equipo de Apoyo D-Care, estamos
    ...
    <div class="bg-white py-6 sm:py-8 lg:py-12 dark:bg-gray-900">
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
            ...
            <div class="mb-10 md:mb-16">
                ...
                <p class="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">Nuestros servicios abarcan
            ...
            <div class="grid gap-x-4 gap-y-8 sm:grid-cols-2 md:gap-x-6 lg:grid-cols-3 xl:grid-cols-3">
                ...
                <div>
                    <a href="#"
                        ...
                        <img src="/build/img/clarisse-meyer-jKU2NneZAbI-unsplash.webp" loading="lazy"
                    ...
                    <div class="flex items-start justify-between gap-2 px-2">
                        <div class="flex flex-col">
                            ...
                            <p class="mb-8 text-gray-500">Brindamos asesoramiento legal especializado, guiando a las
                ...
                <div>
                    <a href="#"
                        class="group relative mb-2 block h-96 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:mb-3">
                        <img src="/build/img/roman-kraft-0EVKn3-5JSU-unsplash.webp" loading="lazy"
                            alt="Photo by Austin Wade"
                            class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
                    </a>
                    ...
                    <div class="flex items-start justify-between gap-2 px-2">
                        <div class="flex flex-col">
                            ...
                            <p class="mb-8 text-gray-500">Nuestro equipo de psicólogos capacitados ofrece un espacio
                ...
                <div>
                    <a href="#"
                        class="group relative mb-2 block h-96 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:mb-3">
                        <img src="/build/img/patty-brito-Y-3Dt0us7e0-unsplash.webp" loading="lazy"
                    ...
                    <div class="flex items-start justify-between gap-2 px-2">
                        <div class="flex flex-col">
                            ...
                            <p class="mb-8 text-gray-500">Proporcionamos atención médica personalizada y
    ...
    <!-- investigaciones -->
    <?php
    require "includes/templates/investigaciones.php"
        ?>
</div>
</body>
